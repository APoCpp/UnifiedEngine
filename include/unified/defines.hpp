...
# define UNIFIED_MODULES_NAMESPACE Modules
# define UNIFIED_MODULES_NAMESPACE_STRING "Modules"

# define UNIFIED_MODULES_BEGIN_NAMESPACE namespace UNIFIED_MODULES_NAMESPACE {
# define UNIFIED_MODULES_END_NAMESPACE }
